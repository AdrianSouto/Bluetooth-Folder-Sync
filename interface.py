...
def on_start():
    ...
    start_sync(peer_addr, local_addr, port, sync_folder)
...
ttk.Button(root, text="Start Sync", command=on_start, style='RoundedButton.TButton').grid(row=4, column=1, padx=10, pady=10)
